<x-app-layout>
    <div class="bg-gray-600 text-white" style="background-image: url('https://source.unsplash.com/1600x900/?tulungagung,landscape'); background-size: cover; background-position: center;">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5">
                    @foreach ($kpiData as $title => $value)
                        ...
                        @endphp
                        <a href="{{ $link }}" class="block bg-white overflow-hidden shadow-sm sm:rounded-lg p-5 text-center transition-transform transform hover:-translate-y-1 hover:shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
                ...
                <div class="lg:col-span-3">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Badan Pusat Statistik (BPS) Kabupaten Tulungagung adalah lembaga vertikal BPS yang bertanggung jawab langsung kepada Kepala BPS Provinsi Jawa Timur. Kami berkomitmen untuk menyediakan data dan informasi statistik yang berkualitas, akurat, dan tepat waktu untuk mendukung perencanaan, monitoring, dan evaluasi pembangunan di Kabupaten Tulungagung.
                    </p>
                </div>
                ...
                <div class="lg:col-span-2 bg-white p-6 shadow-lg rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">Melaksanakan sensus dan survei statistik, mengolah data, serta mempublikasikan hasil statistik untuk masyarakat umum, pemerintah, dan pemangku kepentingan lainnya.</p>
                    </div>
                    <div>
                        <strong class="text-gray-700">Alamat Kantor:</strong>
                        <p class="text-gray-600 mb-4">Jl. Pahlawan No.18, Dusun Krajan, Kedungwaru, Kabupaten Tulungagung, Jawa Timur 66224</p>
                    </div>
    ...
    <script>
        ...
        new Chart(document.getElementById('pendudukChart'),{type:'bar',data:{labels:dataPenduduk.labels,datasets:[{label:'Jumlah Penduduk (Ribu)',data:dataPenduduk.values,backgroundColor:'rgba(54, 162, 235, 0.6)',borderColor:'rgba(54, 162, 235, 1)',borderWidth:1}]},options:{responsive:true,maintainAspectRatio:false,scales:{y:{beginAtZero:false}}}});
        new Chart(document.getElementById('ipmChart'),{type:'line',data:{labels:dataIPM.labels,datasets:[{label:'Skor IPM',data:dataIPM.values,borderColor:'rgba(75, 192, 192, 1)',backgroundColor:'rgba(75, 192, 192, 0.2)',fill:false,tension:0.1}]},options:{responsive:true,maintainAspectRatio:false,scales:{y:{beginAtZero:false}}}});
        new Chart(document.getElementById('inflasiChart'),{type:'line',data:{labels:dataInflasi.labels,datasets:[{label:'Inflasi (%)',data:dataInflasi.values,borderColor:'rgba(255, 99, 132, 1)',backgroundColor:'rgba(255, 99, 132, 0.2)',fill:false,tension:0.2}]},options:{responsive:true,maintainAspectRatio:false,scales:{y:{beginAtZero:false}}}});
        new Chart(document.getElementById('miskinChart'),{type:'bar',data:{labels:dataMiskin.labels,datasets:[{label:'Penduduk Miskin (%)',data:dataMiskin.values,backgroundColor:'rgba(255, 159, 64, 0.6)',borderColor:'rgba(255, 159, 64, 1)',borderWidth:1}]},options:{responsive:true,maintainAspectRatio:false,scales:{y:{beginAtZero:false}}}});
    </script>
</x-app-layout>