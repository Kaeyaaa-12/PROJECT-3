    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 mt-2">Data kualitas hidup dan akses terhadap layanan publik di Kabupaten Tulungagung.</p>
            </div>
            ...
            <div class="mb-16">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 md:p-8 mb-8">
                    ...
                    <p class="text-gray-600 mb-6">Persentase penduduk usia 15 tahun ke atas yang dapat membaca dan menulis (Proyeksi Tahun 2025).</p>
                            ...
                            <table class="min-w-full bg-white border">
                                <thead class="bg-blue-800 text-white">
                                    <tr>
                                        ...
                                        <th class="py-2 px-3 uppercase font-semibold text-sm text-right">Persentase (%)</th>
                                    </tr>
                                </thead>
                                <tbody class="text-gray-700">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-3 text-right font-medium">{{ number_format($data->angka_melek_huruf, 2, ',', '.') }} %</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 md:p-8">
                    ...
                    <p class="text-gray-600 mb-6">Persentase anak pada kelompok usia sekolah tertentu yang sedang bersekolah.</p>
    ...
    <script>
        ...
        new Chart(document.getElementById('amhChart'), {
            ...
            options: {
                ...
                scales: { x: { min: 98 } } // Atur skala minimum agar perbedaan terlihat
            }
        });
    </script>
</x-app-layout>