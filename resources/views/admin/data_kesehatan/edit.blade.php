...
@section('page-title', 'Edit Data Fasilitas Kesehatan')

@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('admin.data_kesehatan.update', $data_kesehatan->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                <label for="tahun" class="block text-sm font-medium text-gray-700">Tahun</label>
                <input type="number" name="tahun" id="tahun" value="{{ old('tahun', $data_kesehatan->tahun) }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" name="jumlah_rumah_sakit" id="jumlah_rumah_sakit"
                        value="{{ old('jumlah_rumah_sakit', $data_kesehatan->jumlah_rumah_sakit) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_puskesmas" id="jumlah_puskesmas"
                        value="{{ old('jumlah_puskesmas', $data_kesehatan->jumlah_puskesmas) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_puskesmas_pembantu" id="jumlah_puskesmas_pembantu"
                        value="{{ old('jumlah_puskesmas_pembantu', $data_kesehatan->jumlah_puskesmas_pembantu) }}" required
